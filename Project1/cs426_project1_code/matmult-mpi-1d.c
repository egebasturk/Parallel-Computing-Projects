...
int main (int argc, char *argv[])
{
    ...
    //printf("Color of %d: %d\n", rank, color);
    /**
     * First groups row communucators
     * Then creates master group for these rows
     * Array1 is scattered to masters
     * Array2 is Broadcasted to masters
     * masters broadcast their part of the Array1
     * and scatter the broadcasted Array2
     * to their row  communicator group
     * */
    MPI_Comm comm_row;
